...
| BlueMap Add-on Adapter API | `0.1.0-alpha.2` / `e81f08bc4bfbf02d810ec8949a019130e2e61634` | MIT | Four source files compiled into this add-on | Source only |
| Railcraft Reborn profile | `railcraft-1.2.10` | See `provenance/upstreams.json` | Exact installed-artifact and resource evidence only | No |
