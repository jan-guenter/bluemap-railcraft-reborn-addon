...
"""Generate the bounded deterministic Railcraft void-chest gallery."""
...
def build_function() -> bytes:
    minimum_x, minimum_y, minimum_z, maximum_x, _, maximum_z = cases.ENVELOPE
    lines = [
        "# Generated by gallery/generate.py; do not edit.",
        f"function {cases.NAMESPACE}:clear",
        f"fill {minimum_x} {minimum_y} {minimum_z} "
        f"{maximum_x} {minimum_y} {maximum_z} minecraft:light_gray_concrete",
    ]
    for placement in cases.PLACEMENTS:
        lines.extend(
            (
...
def verify_function() -> bytes:
    ...
    lines.append(
        "tellraw @a {\"text\":\"Railcraft void-chest gallery checked: "
        "9 blocks\",\"color\":\"green\"}"
    )
    return text_bytes("\n".join(lines))
...
def base_files() -> dict[Path, bytes]:
    ...
    return {
        ...
        Path("datapack/pack.mcmeta"): json_bytes(
            {
                "pack": {
                    "description": "ATM 1.2.0 Railcraft void-chest gallery",
                    "pack_format": 48,
                }
            }
        ),
        ...
        function_root / "load.mcfunction": text_bytes(
            "# Generated by gallery/generate.py; do not edit.\n"
            "tellraw @a {\"text\":\"Railcraft void-chest gallery loaded; "
            f"run /function {cases.NAMESPACE}:build\",\"color\":\"green\"}}"
        ),
