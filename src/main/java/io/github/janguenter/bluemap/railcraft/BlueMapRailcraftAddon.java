...
package io.github.janguenter.bluemap.railcraft;

import io.github.janguenter.bluemap.railcraft.adapter.bluemap522.AdapterCompatibility;

import java.lang.reflect.InvocationTargetException;
import java.lang.reflect.Method;

/** BlueMap add-on entrypoint installed before resource-pack construction. */
public final class BlueMapRailcraftAddon implements Runnable {
    ...
    public void run() {
        try {
            ...
            Class<?> adapter = Class.forName(
                    "io.github.janguenter.bluemap.railcraft.adapter.bluemap522.BlueMap522Adapter",
                    true,
                    BlueMapRailcraftAddon.class.getClassLoader()
            );
    ...
    private static void inactive(String reason, Throwable cause) {
        ...
        System.err.println("BlueMap Railcraft Reborn add-on is inactive: "
                + reason + detail + '.');
    }
}
